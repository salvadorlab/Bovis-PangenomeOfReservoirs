...
logger("creating the assembly submission script")
...
scaffold_file = list(map(lambda x: re.sub('_1.fastq','_scaffold.fa',x), r1))
assemble_dir = list(map(lambda x: re.sub('_1.fastq','_assembly',x), r1))
...
for i in range(len(r1)):
    ...
    logger("DeBrujin Graph Assembly occuring now between {} and {}. Output resides in {} directory".format(r1[i],r2[i],assemble_dir[i]))
